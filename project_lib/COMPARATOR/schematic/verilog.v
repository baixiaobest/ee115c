...
module COMPARATOR (
A4,B4,A3,B3,A2,B2,A1,B1,A0,B0,VDD,GND,OUT );
input  A4;
input  B4;
input  A3;
input  B3;
...
INV    
 I0  ( .VDD( VDD ), .Vin( A4 ), .Vout( net61 ), .GND( GND ) );
...
ANDx4    
 I49  ( .VDD( VDD ), .C( net68 ), .A( net71 ), .D( net34 ), .B( net69 ), .OUT( net059 ), .GND( GND ) );

ANDx5    
 I50  ( .VDD( VDD ), .C( net68 ), .A( net42 ), .GND( GND ), .D( net69 ), .B( net67 ), .OUT( net062 ), .E( net71 ) );

ORx5    
 I51  ( .VDD( VDD ), .C( net063 ), .A( net40 ), .E( net062 ), .D( net059 ), .B( net060 ), .OUT( OUT ), .GND( GND ) );
